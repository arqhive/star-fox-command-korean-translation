...
trans/src/<청크>.json 원문과 trans/ko/<청크>.json 번역을 대조해 문제를 출력한다."""
import json,sys,re,os
import romfiles, paths
os.chdir(paths.HERE)
from ko_metrics import FontInfo, FONTMAP
name=sys.argv[1]
src=json.load(open(f'trans/src/{name}.json',encoding='utf-8'))
try: ko=json.load(open(f'trans/ko/{name}.json',encoding='utf-8'))
